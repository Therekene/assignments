...
function getTodos() {
    axios.get("https://api.vschool.io/nateb/todo")
        .then(response => {
...
function listTodos(todos) {
    ...
    if (todos[i].completed) {
        ...
        checkbox.addEventListener("change", function () {
            ...
            if (checkbox.checked) {
                axios.put("https://api.vschool.io/nateb/todo/" + todos[i]._id, { completed: true })
                .then(response => {
                    getTodos()
            ...
            } else axios.put("https://api.vschool.io/nateb/todo/" + todos[i]._id, { completed: false })
            .then(response => {
                getTodos()
                console.log(response.data)
            })
        ...
        deleteBtn.addEventListener("click", function () {
            axios.delete("https://api.vschool.io/nateb/todo/" + todos[i]._id, { completed: true })
            .then(response => {
                getTodos()
                console.log(response.data)
            })
...
function editIt(newDiv, todo){
    ...
    editForm.appendChild(editSubmit)
        ...
        editForm.addEventListener("submit", function (event){
           ...
           axios.put("https://api.vschool.io/nateb/todo/"+ todo._id, newForm)
           .then(response => {
               getTodos()
...
axios.post("https://api.vschool.io/nateb/todo", newTodo)
        .then(response => {
            getTodos()
